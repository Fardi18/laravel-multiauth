                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form method="POST" action="{{ route('do.userregister') }}" class="mx-1 mx-md-4">
                                        @csrf
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <textarea type="address" class="form-control @error('address') is-invalid @enderror" name="address" id="address"
                                                    aria-describedby="addressHelp" placeholder="Masukkan alamat"></textarea>
                                                @error('address')
                                        ...
                                        <p class="text-center">Sudah memiliki akun? <a href="/login"><b>Login</b></a>
                                        </p>
